...
findings:
  - id: T-1
    area: ""                   # category ΓÇö e.g., "AC specificity", "Test coverage"
    severity: green            # red | yellow | green
    finding: ""                # what you found (Γëñ15 words)
    suggestion: ""             # recommended change (Γëñ15 words)

untestable_criteria: []        # AC IDs that cannot be verified ΓÇö e.g., ["AC-5", "AC-12"]

missing_coverage:              # items or configs with no acceptance criteria
  - item: ""                   # item name
    gap: ""                    # what's missing (Γëñ15 words)

blockers:
  architecture: []             # decisions that must resolve before FINAL (Γëñ15 words each)
  deployment: []               # infra/creds needed before deploy ΓÇö do NOT block sign-off (Γëñ15 words each)
...
- **`review_iteration`** = Tracks which review cycle this is. Max 3 iterations ΓÇö after 3, escalate to user.
