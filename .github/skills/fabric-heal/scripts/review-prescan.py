...
pre-filled review findings. Consumed by fabric-heal/analyze-inefficiencies.py
to mine recurring patterns across project handoffs.

Usage:
    python .github/skills/fabric-heal/scripts/review-prescan.py --handoff projects/my-project/docs/architecture-handoff.md
    python .github/skills/fabric-heal/scripts/review-prescan.py --handoff handoff.md --format json
    python .github/skills/fabric-heal/scripts/review-prescan.py --handoff handoff.md --output review.json
...
def prescan(handoff_path: str) -> dict:
    ...
    Returns a dict of pre-scan findings (project, task_flow, findings list,
    wave_optimization, etc.), augmented with scan_type: automated.
    """
